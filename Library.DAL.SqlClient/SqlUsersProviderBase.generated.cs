...
namespace Library.DAL.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@UserType_ID", DbType.Int32, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@DeletedBy", DbType.Int32, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("usertype_id ") || clause.Trim().StartsWith("usertype_id="))
				{
					database.SetParameterValue(commandWrapper, "@UserType_ID", 
						clause.Trim().Remove(0,11).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Users> GetByUserType_ID(TransactionManager transactionManager, System.Int32 _userType_ID, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Users_GetByUserType_ID", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@UserType_ID", DbType.Int32, _userType_ID);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByUserType_ID", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByUserType_ID", rows)); 
			}
			finally
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override Library.BLL.Users GetByUserName(TransactionManager transactionManager, System.String _userName, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override Library.BLL.Users GetByID(TransactionManager transactionManager, System.Int32 _iD, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<Library.BLL.Users> entities)
		{
			...
			DataColumn col8 = dataTable.Columns.Add("UserType_ID", typeof(System.Int32));
			col8.AllowDBNull = false;		
			DataColumn col9 = dataTable.Columns.Add("First_Name", typeof(System.String));
			col9.AllowDBNull = true;		
			DataColumn col10 = dataTable.Columns.Add("Last_Name", typeof(System.String));
			col10.AllowDBNull = true;		
			DataColumn col11 = dataTable.Columns.Add("Email", typeof(System.String));
			col11.AllowDBNull = true;		
			DataColumn col12 = dataTable.Columns.Add("Country", typeof(System.String));
			...
			DataColumn col15 = dataTable.Columns.Add("Mobile", typeof(System.String));
			col15.AllowDBNull = true;		
			DataColumn col16 = dataTable.Columns.Add("Phone", typeof(System.String));
			col16.AllowDBNull = true;		
			DataColumn col17 = dataTable.Columns.Add("Postion", typeof(System.String));
			col17.AllowDBNull = true;		
			DataColumn col18 = dataTable.Columns.Add("Is_Deleted", typeof(System.Boolean));
			col18.AllowDBNull = true;		
			DataColumn col19 = dataTable.Columns.Add("CreatedOn", typeof(System.DateTime));
			col19.AllowDBNull = true;		
			DataColumn col20 = dataTable.Columns.Add("CreatedBy", typeof(System.Int32));
			col20.AllowDBNull = true;		
			DataColumn col21 = dataTable.Columns.Add("UpdatedOn", typeof(System.DateTime));
			col21.AllowDBNull = true;		
			DataColumn col22 = dataTable.Columns.Add("UpdatedBy", typeof(System.Int32));
			col22.AllowDBNull = true;		
			DataColumn col23 = dataTable.Columns.Add("DeletedOn", typeof(System.DateTime));
			col23.AllowDBNull = true;		
			DataColumn col24 = dataTable.Columns.Add("DeletedBy", typeof(System.Int32));
			...
			bulkCopy.ColumnMappings.Add("UserType_ID", "UserType_ID");
			...
			foreach(Library.BLL.Users entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["Last_Logout"] = entity.Last_Logout.HasValue ? (object) entity.Last_Logout  : System.DBNull.Value;
							
				
					row["Is_Online"] = entity.Is_Online;
							
				
					row["Is_Active"] = entity.Is_Active;
							
				
					row["Is_Admin"] = entity.Is_Admin;
							
				
					row["UserType_ID"] = entity.UserType_ID;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, Library.BLL.Users entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			...
			database.AddInParameter(commandWrapper, "@Last_Logout", DbType.DateTime, (entity.Last_Logout.HasValue ? (object) entity.Last_Logout  : System.DBNull.Value));
            database.AddInParameter(commandWrapper, "@Is_Online", DbType.Boolean, entity.Is_Online );
            database.AddInParameter(commandWrapper, "@Is_Active", DbType.Boolean, entity.Is_Active );
            database.AddInParameter(commandWrapper, "@Is_Admin", DbType.Boolean, entity.Is_Admin );
            database.AddInParameter(commandWrapper, "@UserType_ID", DbType.Int32, entity.UserType_ID );
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, Library.BLL.Users entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
