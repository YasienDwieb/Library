/*
	...
	Important: Do not modify this file. Edit the file SqlBookImageProvider.cs instead.
*/
...
namespace Library.DAL.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlBookImageProviderBase : BookImageProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlBookImageProviderBase"/> instance.
		/// </summary>
		public SqlBookImageProviderBase()
		{
		}
	...
	public SqlBookImageProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
