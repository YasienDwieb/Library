/*
	...
	Important: Do not modify this file. Edit the file SqlCourseProvider.cs instead.
*/
...
namespace Library.DAL.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlCourseProviderBase : CourseProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlCourseProviderBase"/> instance.
		/// </summary>
		public SqlCourseProviderBase()
		{
		}
	...
	public SqlCourseProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _iD)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Course_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Course)
					,_iD);
		...
		public override TList<Course> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<Course>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Course_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@Course_Name", DbType.String, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Course_Scope", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Duration", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@DurationType_ID", DbType.Int32, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@DeletedBy", DbType.Int32, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				{
					database.SetParameterValue(commandWrapper, "@Course_Name", 
						clause.Trim().Remove(0,11).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("course_scope ") || clause.Trim().StartsWith("course_scope="))
				{
					database.SetParameterValue(commandWrapper, "@Course_Scope", 
				...
				if (clause.Trim().StartsWith("durationtype_id ") || clause.Trim().StartsWith("durationtype_id="))
				{
					database.SetParameterValue(commandWrapper, "@DurationType_ID", 
			...
			//Create Collection
			TList<Course> rows = new TList<Course>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Library.BLL.Course objects.</returns>
		public override TList<Course> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Course_Find_Dynamic", typeof(CourseColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Course> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Course_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Library.BLL.Course objects.</returns>
		public override TList<Course> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Course_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override Library.BLL.Course GetByID(TransactionManager transactionManager, System.Int32 _iD, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Course_GetByID", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@ID", DbType.Int32, _iD);
			
			IDataReader reader = null;
			TList<Course> tmp = new TList<Course>();
			try
			{
				//Provider Data Requesting Command Event
