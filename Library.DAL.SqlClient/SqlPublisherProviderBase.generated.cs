/*
	...
	Important: Do not modify this file. Edit the file SqlPublisherProvider.cs instead.
*/
...
namespace Library.DAL.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlPublisherProviderBase : PublisherProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlPublisherProviderBase"/> instance.
		/// </summary>
		public SqlPublisherProviderBase()
		{
		}
	...
	public SqlPublisherProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _iD)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Publisher_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Publisher)
					,_iD);
		...
		public override TList<Publisher> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<Publisher>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Publisher_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@Mobile", DbType.StringFixedLength, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@FounedOn", DbType.Date, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@Address", DbType.String, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("founedon ") || clause.Trim().StartsWith("founedon="))
				{
					database.SetParameterValue(commandWrapper, "@FounedOn", 
			...
			//Create Collection
			TList<Publisher> rows = new TList<Publisher>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Library.BLL.Publisher objects.</returns>
		public override TList<Publisher> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Publisher_Find_Dynamic", typeof(PublisherColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Publisher> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Publisher_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Library.BLL.Publisher objects.</returns>
		public override TList<Publisher> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Publisher_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override Library.BLL.Publisher GetByID(TransactionManager transactionManager, System.Int32 _iD, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Publisher_GetByID", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@ID", DbType.Int32, _iD);
			
			IDataReader reader = null;
			TList<Publisher> tmp = new TList<Publisher>();
			try
			{
				//Provider Data Requesting Command Event
