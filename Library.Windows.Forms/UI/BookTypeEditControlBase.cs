...
{
	/// <summary>
	/// This is the abstract edit form for the <see cref="BLL.BookType"/> entity.
	/// </summary>
	/// <remarks>This class is overwritten by .netTiers at each generation.</remarks>
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	public abstract class BookTypeEditControlBase : System.Windows.Forms.UserControl
	{
		#region Fields
		...
		/// <summary>
		/// Gets or sets the <see cref="BLL.BookType"/> entity to edit with this form.
		/// </summary>
		/// <value>The <see cref="BLL.BookType"/> instance.</value>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="BookTypeEditControlBase"/> class.
		/// </summary>
		public BookTypeEditControlBase()
		{
			InitializeComponent();			
		...
		{
			if (_BookType != null) _BookType.Validate();
		}	
		...
		public void InitializeComponent()
		{
			...
			// 
			// BookTypeEditControlBase
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			//this.Controls.Add(this.uxTableLayoutPanel);
			this.AutoScroll = true;
			this.Name = "BookTypeEditControlBase";
