...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataLast_Logout" Text='<%# Bind("Last_Logout", "{0:d}") %>' MaxLength="10"></asp:TextBox><asp:ImageButton ID="cal_dataLast_Logout" runat="server" SkinID="CalendarImageButton" OnClientClick="javascript:showCalendarControl(this.previousSibling);return false;" /><asp:RequiredFieldValidator ID="ReqVal_dataLast_Logout" runat="server" Display="Dynamic" ControlToValidate="dataLast_Logout" ErrorMessage="Required"></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataFirst_Name" Text='<%# Bind("First_Name") %>' MaxLength="50"></asp:TextBox><asp:RequiredFieldValidator ID="ReqVal_dataFirst_Name" runat="server" Display="Dynamic" ControlToValidate="dataFirst_Name" ErrorMessage="Required"></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataLast_Name" runat="server" Text="Last Name:" AssociatedControlID="dataLast_Name" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataLast_Name" Text='<%# Bind("Last_Name") %>' MaxLength="50"></asp:TextBox><asp:RequiredFieldValidator ID="ReqVal_dataLast_Name" runat="server" Display="Dynamic" ControlToValidate="dataLast_Name" ErrorMessage="Required"></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataCountry" Text='<%# Bind("Country") %>' MaxLength="50"></asp:TextBox><asp:RequiredFieldValidator ID="ReqVal_dataCountry" runat="server" Display="Dynamic" ControlToValidate="dataCountry" ErrorMessage="Required"></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataMobile" Text='<%# Bind("Mobile") %>' MaxLength="50"></asp:TextBox><asp:RequiredFieldValidator ID="ReqVal_dataMobile" runat="server" Display="Dynamic" ControlToValidate="dataMobile" ErrorMessage="Required"></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
