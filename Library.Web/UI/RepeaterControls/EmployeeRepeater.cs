...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						Library.BLL.Employee entity = o as Library.BLL.Employee;
	...
	{
		private Library.BLL.Employee _entity;
        ...
        /// Initializes a new instance of the <see cref="T:EmployeeItem"/> class.
        /// </summary>
		public EmployeeItem(Library.BLL.Employee entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:Library.BLL.Employee"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public Library.BLL.Employee Entity
        {
            get { return _entity; }
        }
	}
